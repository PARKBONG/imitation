from imitation.algorithms.adversarial.ird_fixed import IRDFIX
...
def main(cfg: DictConfig):
    ...
    primary_net = BasicRewardNet(
            venv.observation_space, venv.action_space,  use_action=True, #normalize_input_layer=normalize_layer[normalize], #RunningNorm, #RunningNorm,
        hid_sizes=[hid_size, hid_size],
    )
    gail_trainer = IRDFIX(
